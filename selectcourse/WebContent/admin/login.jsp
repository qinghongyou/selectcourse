...
<html>
	...
	<body style="background-color:#df7611; background-image:url(http://localhost:8088/selectcourse/resources/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
		...
		<div class="logintop">    
		    ...
		    <form action="/selectcourse/AdminServlet?action=logon" method="post">
		    <div class="loginbox loginbox1">
			    <ul>
			    <li><input name="admName" type="text" class="loginuser" value="用户名" onclick="JavaScript:this.value=''"/></li>
			    <li><input name="admPwd" type="password" class="loginpwd" value="密码" onclick="JavaScript:this.value=''"/></li>
