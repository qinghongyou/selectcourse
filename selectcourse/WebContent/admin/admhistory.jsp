...
<body>
   ...
   %>
    <div class="pagin">
        ...
        <ul class="paginList">
        <li class="paginItem"><a href="/selectcourse/ShowLogServlet?action=findHisAdm&stuId=1&page=${paging.indexpage-1}">首页</a></li>
        <li class="paginItem"><a href="/selectcourse/ShowLogServlet?action=findHisAdm&stuId=1&page=${paging.page-1}"><span class="pagepre"></span></a></li>
        <li class="paginItem"><a href="javascript:;">${paging.page+1}</a></li>
        <li class="paginItem"><a href="/selectcourse/ShowLogServlet?action=findHisAdm&stuId=1&page=${paging.page+1}"><span class="pagenxt"></span></a></li>
        <li class="paginItem"><a href="/selectcourse/ShowLogServlet?action=findHisAdm&stuId=1&page=${paging.pagenumber-1}">尾页</a></li>
        </ul>
    </div>
    <%
   	}
