...
<body>
    ...
    <div class="rightinfo">
    	...
    	<div style="margin-top: 20px">
	    	<input name="" type="submit" onclick="javascript:window.location.href='/selectcourse/StuCouServlet?action=findMyCou&stuId=<%=stus1.getStuId() %>'" class="scbtn1" value="返回"/></li>  
    	</div>
    	</center>
   	</div>
</body>
