...
<body>
    ...
    <div class="tools">
    	<form action="/selectcourse/CourseServlet?action=findCourse" method="post">
    	<ul class="seachform1">
    ...
    <table class="tablelist">
        ...
        <tbody>
	        ...
	        <tr>
				...
				%> 
		        <td><a href="/selectcourse/StuCouServlet?action=addCou&stuId=<%=stus1.getStuId() %>&couId=<%=course.getCouId() %>" class="tablelink">选课</a></td>
	        </tr> 
	        <%
        			}
        		}else{
   ...
   <!--  <div class="tip">
      ...
      <div class="tipinfo">
        <span><img src="http://localhost:8088/selectcourse/resources/images/ticon.png" /></span>
        <div class="tipright">
        <p>是否确认对信息的修改 ？</p>
